...
export default function BenefitSection() {
    return (
        <S.Container>
            <S.BenefitSectionImage src='/images/components/benefit-section/1.png' alt='Benefit Section' />
            <S.BenefitSectionContent>
                ...
                <S.BenefitSectionDescription>
                    A traditional approach while imagining what the furniture of tomorrow could be, in its use and representation.
                </S.BenefitSectionDescription>
